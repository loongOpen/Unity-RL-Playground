...
namespace RosMessageTypes.UnitreeGo
{
    ...
    {
        public const string k_RosMessageName = "unitree_go/IMUState";
        ...
        public IMUStateMsg(float[] quaternion, float[] gyroscope, float[] accelerometer, float[] rpy, sbyte temperature)
        {
