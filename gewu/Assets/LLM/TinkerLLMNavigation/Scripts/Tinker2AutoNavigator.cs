...
public class Tinker2AutoNavigator : MonoBehaviour
{
    public Tinker2Agent agent;
    ...
    void Update()
    {
        ...
        else
        {
            ...
            agent.wr = Mathf.Clamp(wr_p / 45f, -0.5f, 0.5f);
        }
         //解除v1禁用，允许前进
        //agent.vr = Mathf.Clamp(horizontalDist, -0.4f, 0.4f);
