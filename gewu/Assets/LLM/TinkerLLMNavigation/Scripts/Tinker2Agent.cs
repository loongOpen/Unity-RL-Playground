...
public class Tinker2Agent : Agent
{
    ...
    void FixedUpdate()
    {
        ...
        //bool Fallen = Vector3.Angle(body.up, Vector3.up) > 25f || body.position.y < -0.505f;
        //if (Fallen)
        //{
        //    this.transform.GetComponent<BehaviorParameters>().Model = standUp;
        //    isStand = true;
        //}
        //else
        //{
        //    this.transform.GetComponent<BehaviorParameters>().Model = tinker2;
        //    isStand = false;
        //}
    }
}
