...
6.打开项目后，在Unity的Window->Package Manager中点击“+”，点击Add package from disk，选择第4步下载的插件URDF-Importer-main\com.unity.robotics.urdf-importer\package文件打开，完成URDF importer的导入
